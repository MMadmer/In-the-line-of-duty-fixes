...
* Абраму на Свалке можно отказать в пистолете — второй ответ снова в списке; все четыре рецепта на верстаке 2-го уровня собираются, недостающие детали лежат в тайниках мода.
* На Агропроме вместо второго клона статиста появляется «Нэмо» с FN2000, как и было задумано.
* Детекторы находят артефакты, выпавшие из аномалии при вас, включая дорогие, и больше не метят ящики и запчасти; «Отклик» пульсирует тем чаще, чем ближе находка.
...
Working through the mod's forum thread
...
* Abram can be refused the pistol - the second answer is back in the list; all four level-2 workbench recipes can be built, with the missing parts in the mod's own stashes.
* On Agroprom "Nemo" with his FN2000 appears instead of a second copy of the extra, as intended.
* Detectors find artefacts an anomaly drops in front of you, expensive ones included, and stop marking crates and car parts; the cheap one pulses faster as you close in.
